...
<!-- Replace the "Clear Filter" button with a Font Awesome icon -->
<div class="filter" id="filContainer">
    <input type="date" id="filterDate" placeholder="Filter by Date" style="margin-left: 300px">
    <button id="clearFilter" class="btn2" title="Clear Filter"><i class="fas fa-times"></i></button>
</div>

@foreach ($team as $people )

<div class="tableDiv" id="tableDivID" >
    <table border="1" class="table" id="paymentTable">
        <thead id="thead" >
            <tr>
                <th>Mony</th>
                <th>Reason</th>
        ...
        <tbody>
            @foreach ($people->payment as $payment )
                <tr>
                <td>{{ $payment->mony }}</td>
                <td style="max-width: 100px;word-wrap: break-word;">{{ $payment->reason }}</td>
              ...
              <div class="row" >
                <div class="col-sm-4 border-right"><br><br><br><br><br><br><br><br>
                  <div class="description-block">
                    <span class="description-text"  id="totalDisplay">الكلي</span>
                    <h5 class="description-header">{{ $people->totalPrice }}</h5>
                    ------------
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <span class="description-text">عدد مرات السحب</span>
                    <h5 class="description-header">{{ $people->count }}</h5>
...
document.getElementById('delete').onclick = function() {
    ...
    fetch('del', {
        ...
        body: JSON.stringify({ id: {{ $team[0]->id }} })
    })
