...
<div style=" margin-left: 300px; margin-top: 10px;display: flex;" id="container-header">
    <h2 style="color: gray">الأصناف المحذوفة</h2>
    <div id="search"style="margin-left: 800px;">
        <form action="DelType" style="display: inline-block;">
            @csrf
...
<div class="container" id="containerID">
    ...
    <div class="card" data-id="{{ $product->id }}">
        ...
        <div class="button-container">
            ...
            <button class="undelete-button" style="width: 100%" id='undelete' onclick="Undel({{ $product->id }})">Un Delete</button>
